...
<div class="container-fluid">
   ...
   <div class="row heading-bg">
      <div class="col-lg-10 col-md-8 col-sm-8 col-xs-12">
         <h5 class="txt-dark">News Feed Image</h5>
      </div>
      <!-- Breadcrumb -->
      <div class="col-lg-2 col-sm-4 col-md-4 col-xs-12">
         <a href="{{url('newsfeed')}}" class="btn btn-primary">
            ...
            <div class="panel-wrapper collapse in">
               <div class="panel-body pa-0">
                  <article class="col-item">
                     <div class="photo">
                        <div class="options">
                           <a href="javascript:void(0);" class="font-18 txt-grey mr-10 pull-left newsimage_edit" data-id="{{$image->id}}"><i class="zmdi zmdi-edit"></i></a>
                           <a href="javascript:void(0);" class="font-18 txt-grey pull-left sa-warning newsimage_delete" data-id="{{$image->id}}"><i class="zmdi zmdi-close"></i></a>
                        </div>
                        <a href="javascript:void(0);"> <img src="{{url('public/'.$image->newsfeed_image)}}" class="img-responsive" alt="Product Image"> </a>
                     </div>
                     <div class="info">
   ...
   <!-- /Product Row Four -->
         ...
         <!-- Modal -->
<div id="NewsFeedImage" class="modal fade" role="dialog">
   <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit News Feed Image</h4>
         </div>
         <div class="modal-body">
            <form method="post" id="newsimage_form"  enctype="multipart/form-data">
               {{ csrf_field() }} 
               ...
               <input type="hidden"  id="newsimage_id" name="newsimage_id">
         </div>
